...
const sendMail = async(to, url, text) => {
  ...
  try {
    ...
    const options = {
      ...
      to,
      subject: `Premium Messenger - ${text}`,
      html: `
        <div style="border: 5px solid #ccc; padding: 15px;">
          <h1 style="text-align: center;">Premium Messenger ${text}</h1>
          ...
          <div style="margin-top: 20px;">
            <p>Thank you for using <strong>Premium Messenger</strong> for chatting with people around the world
            <p>Warm Regards,</p>
            <p>- Premium Messenger Team -</p>
          </div>
        </div>
      `
    }
